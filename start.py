...
if __name__ == "__main__":
    ...
    data_preprocess.combine_test_data()

    train_x, train_y = data_preprocess.return_train_data(list(range(50)) + list([61, 62]))
    test_x, test_y = data_preprocess.return_test_data(list(range(50)) + list([61, 62]))
    ...
    # neural_network = NeuralNetwork(number_feature=train_x.shape[1], number_hidden=3, number_output=1
    #                                , number_layer=1)
